...
import { getUserByEmailAndPassword, getUserById, checkUsernameExists, createUser, getUserByVerifyToken, confirmUserVerified, } from '../services/user.service.js';
...
export async function register(req, res) {
    ...
    try {
        ...
        sendVerificationMail(email, username, verifyToken).catch((err) => console.error('[Mail] Verifikationsmail fehlgeschlagen:', err));
